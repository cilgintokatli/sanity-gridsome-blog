<template>
    ...
    <nav class="mx-auto flex flex-wrap lg:flex-col	justify-between items-center py-8 px-5 bg-maincolor">
            <HeaderLogo />
        ...
        <ul :class="isOpen ? 'block': 'hidden'" class="bg-maincolor flex flex-col  lg:block">
